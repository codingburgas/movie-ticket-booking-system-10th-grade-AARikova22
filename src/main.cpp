...
int main() {
    ...
    hall1.silverSeatsCount = 20;
    hall1.goldSeatsCount = 10;
    hall1.platinumSeatsCount = 5;

    Hall hall2;
    hall2.HallNumber = 2;
    hall2.shows = { whatwedointheshadows, thebookofgenry };
    hall2.silverSeatsCount = 20;
    hall2.goldSeatsCount = 10;
    hall2.platinumSeatsCount = 5;

    Hall hall3;
    hall3.HallNumber = 3;
    hall3.shows = { labyrinth, coraline };
    hall3.silverSeatsCount = 20;
